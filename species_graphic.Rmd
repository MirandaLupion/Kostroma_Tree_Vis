...
ggplot(df_buysky, aes( x = x, y = y , fill = category)) +
  ...
  labs(x = NULL, y = NULL, 
             title = "Percent of trees by species in Buysky District",
  ...
  # scale_fill_manual(title = "Species", labels = c("Aspen", "Birch", "Birch and Alder", "Birch and Aspen", "Pine", "Spruce", "Spruce and Pine")) 
